...
<div class="flex items-center mb-4">
    ...
    <h1 class="text-xl font-extrabold text-gray-900 ml-2">Daftar Karyawan</h1>
</div>
    ...
    <table class="min-w-full bg-white border">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2 px-4 border-b">{{ $employee->no_telp }}</td>
                <td class="py-2 px-4 border-b">{{ $employee->address }}</td>
                <td class="py-2 px-4 border-b">
                    <a href="{{ route('employee.show', $employee->id) }}" class="text-blue-500">Lihat</a>
                    <a href="{{ route('employee.edit', $employee->id) }}" class="text-yellow-500">Edit</a>
