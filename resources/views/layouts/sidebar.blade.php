        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-50 border-r border-gray-200" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('vacation/index') }}" class="flex items-center p-2 text-gray-900 rounded-lg group hover:bg-orange-500 hover:text-white transition duration-200 {{ request()->is('vacation/index') ? 'bg-orange-500 text-white' : '' }}">
