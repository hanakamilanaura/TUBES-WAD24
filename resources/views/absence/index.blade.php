...
@section('content')
        ...
        <h1 class="text-xl font-extrabold text-gray-900 ml-2">Attendance</h1>
    </div>
        ...
        @endif
        <div class="mt-4 mb-4">
            <a href="{{ route('absence.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Add Attendance</a>
        </div>
        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 border-b">Last Division</th>
                    ...
                    <th class="py-2 px-4 border-b">Is Late</th>
