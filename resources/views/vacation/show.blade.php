...
<div class="container mt-5">
    <div class="flex items-center mb-4">
        ...
        <h1 class="text-xl font-extrabold text-gray-900 ml-2">Detail Cuti</h1>
    </div>

    <div class="bg-white p-4 rounded-md shadow">
        <p><strong>ID:</strong> {{ $vacation->id }}</p>
        <p><strong>Nama Karyawan:</strong> {{ $vacation->employee->name }}</p>
